...
import com.seasonyuu.getgrade.net.api.GetInformation;
import com.seasonyuu.getgrade.net.api.GetInformationAvatar;
...
public class GetInformationActivity extends BaseActivity implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		((CollapsingToolbarLayout) findViewById(R.id.get_information_collapsing_toolbar)).setTitle(getString(R.string.get_information));
